...
public class CursoLogic {
    ...
    public ArrayList<Curso> obtenerCursosParalelos(String seccion, String curso){
        return cdb.buscarParalelos(seccion, curso);
    }
    ...
    public boolean eliminarParalelo(String curso){
        return cdb.eliminarParalelo(curso);
    }
}
